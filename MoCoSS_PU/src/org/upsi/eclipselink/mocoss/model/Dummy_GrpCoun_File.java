...
/**
 * The persistent class for the "dummy_GrpCoun_File" database table.
 * 
 */
@Entity
@Table(name="\"dummy_GrpCoun_File\"")
@NamedQuery(name="Dummy_GrpCoun_File.findAll", query="SELECT d FROM Dummy_GrpCoun_File d")
public class Dummy_GrpCoun_File implements Serializable {
