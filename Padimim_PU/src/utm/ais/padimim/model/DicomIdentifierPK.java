...
/**
 * The primary key class for the DicomIdentifiers database table.
 * 
 */
@Embeddable
public class DicomIdentifierPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof DicomIdentifierPK)) {
			return false;
		}
		DicomIdentifierPK castOther = (DicomIdentifierPK)other;
		return 
