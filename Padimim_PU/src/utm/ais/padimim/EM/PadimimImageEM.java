...
public abstract class PadimimImageEM  {
	...
	public static  Map<String, Object> init() {
		...
		properties.put(PersistenceUnitProperties.CLASSLOADER,PadimimImageEM.class.getClassLoader());
		...
		System.out.print("init PadimimImageEM...");
		return properties;
	}
